...
The agent reads the `.mdx` documentation, stories, and documentation images (including dos and don'ts screenshots) for each component, then writes a `SKILL.md` to `skills/best-practice/<name>/`.
